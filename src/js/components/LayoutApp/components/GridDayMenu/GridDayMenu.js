...
const GridDayMenuComponent = ( props ) => {
    ...
    // let [ weekNames, setWeekNames ] = useState( null );
    ...
    //         obj[ WEEK[ i ].INDEX ] = WEEK[ i ].FULL_NAME;
    //     };
    ...
    // const getDayName = ( currentDay ) => {
    //     let result = '';
    //     if( weekNames !== null ){
    //         result = weekNames[ currentDay ];
    //     };
    ...
    return (
        <div className = 'gridDayMenu'>
            ...
            <div className = 'gridDayName'>
                {/* <span>{ getDayName( gridCurrentDay ) }</span> */}
